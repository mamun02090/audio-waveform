...
const canvasHeight = canvas.offsaetHeight;
...
const draw = (normalizedData) => {
    ...
    const widthSample = (canvasWidth) / bufferLength;
...
const drawLineSegment = (ctx, x, y, width) => {
    ctx.lineWidth = 0.5; // how thick the line is
    ...
    if (y === 0) {
        ...
        // ctx.lineTo(x + width, centerY); // Draw a line up or down from the center
        ctx.lineTo(x, centerY - y); // Draw a line up or down from the center
